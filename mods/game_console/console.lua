...
function init()
  ...
  g_keyboard.bindKeyDown('Ctrl+D', function() consoleToggleChat:setChecked(not consoleToggleChat:isChecked()) toggleChat() end)
...
function enableChat()
  ...
  removeEvent(DashEvent)
  --g_keyboard.unbindKeyPress("W", gameRootPanel)
  --g_keyboard.unbindKeyPress("A", gameRootPanel)
  --g_keyboard.unbindKeyPress("S", gameRootPanel)
  --g_keyboard.unbindKeyPress("D", gameRootPanel)
  --g_keyboard.unbindKeyPress("E", gameRootPanel)
  --g_keyboard.unbindKeyPress("Q", gameRootPanel)
  --g_keyboard.unbindKeyPress("Z", gameRootPanel)
  --g_keyboard.unbindKeyPress("C", gameRootPanel)
...
function disableChat()
  ...
  removeEvent(DashEvent)
  DashEvent = cycleEvent(function () modules.game_interface.dash_loop() end, 50)

  --g_keyboard.bindKeyPress('W', function() gameInterface.dash('North') end, gameRootPanel)
  --g_keyboard.bindKeyPress('D', function() gameInterface.dash('East') end, gameRootPanel)
  --g_keyboard.bindKeyPress('S', function() gameInterface.dash('South') end, gameRootPanel)
  --g_keyboard.bindKeyPress('A', function() gameInterface.dash('West') end, gameRootPanel)
  --g_keyboard.bindKeyPress('E', function() gameInterface.dash('NorthEast') end, gameRootPanel)
  --g_keyboard.bindKeyPress('Q', function() gameInterface.dash('NorthWest') end, gameRootPanel)
  --g_keyboard.bindKeyPress('C', function() gameInterface.dash('SouthEast') end, gameRootPanel)
  --g_keyboard.bindKeyPress('Z', function() gameInterface.dash('SouthWest') end, gameRootPanel)
